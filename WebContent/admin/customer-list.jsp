...
<title>QUẢN LÝ KHÁCH HÀNG - ICHI ĐÀ NẴNG</title>
...
<body>
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12 page-header-movie-list">
					<h5 class="title-page">DANH SÁCH THÀNH VIÊN</h5>
			...
			<div class="row panel my-panel-default">
				<div class="panel-body movie-list-panel">
					...
					<div class="text-center">
						...
						<html:link action="/customer.html?action=toAdd">
	...
	<script type="text/javascript" src="dist/js/customer.js"></script>
