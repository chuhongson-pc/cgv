...
<meta charset="UTF-8">
    ...
    <title>THÔNG TIN PHÒNG CHIẾU - ICHI ĐÀ NẴNG</title>
...
<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h5 class="title-page"><html:link action="/room?action=list">[DANH SÁCH PHÒNG CHIẾU]</html:link> > THÔNG TIN PHÒNG CHIẾU</h5>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <html:submit property="action" value="delete" styleClass="btn btn-delete" onclick="return $(this).checkDecideDel();"/>
...
<script type="text/javascript">
      ...
      $.fn.checkDecideDel = function() {
      	var rg = window.confirm("Bạn thực sự muốn xóa phòng này ?")
      	if (rg != true) {
      		return false;
      	} else
      		return true;
