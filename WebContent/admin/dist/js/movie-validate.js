    ...
    //
     ...
     var validator = $("#movie_form").validate({
        ...
        messages: {
            ...
            'currentMovie.theLoai': {
            	required: "Bạn vui lòng nhập dữ liệu.",
                minlength: jQuery.validator.format("Thể loại phải có ít nhất {0} ký tự"),
                maxlength: jQuery.validator.format("Thể loại phải ít hơn {0} ký tự"),
            },
            'currentMovie.nhaSX': {
            	required: "Bạn vui lòng nhập dữ liệu.",
            ...
            'thumbnailFile': {
            	required: "Bạn vui lòng chọn file ảnh thumbnail."
            },
            'bannerFile':{
            	required: "Bạn vui lòng chọn file ảnh banner."
