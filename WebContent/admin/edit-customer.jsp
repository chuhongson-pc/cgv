...
<meta charset="UTF-8">
    ...
    <title>THÔNG TIN KHÁCH HÀNG - CGV ĐÀ NẴNG</title>
...
<body>
<div id="wrapper">
		<input type="hidden" value="customer" id="selected_tab_panel"/>
        ...
        <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="title-page">THÔNG TIN KHÁCH HÀNG</h5>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <bean:define id="customer" name="customerAdminForm" property="currentCustomer"/>
                                            <p class="form-control-static username-label"><bean:write property="username" name="customer"/></p>
                                    </div>
                                    ...
                                    <div class="form-group">                                   
                                     ...
                                     <div class="form-group">
                                        ...
                                        <p class="form-control-static"><bean:write property="ngayKhoiTao" name="customer"/></p>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <html:text property="currentCustomer.diemTichLuy" name="customerAdminForm" styleClass="form-control"/>
                                        <p class="help-block custom-error-message"></p>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Trạng thái</label>                                                                               
                                        <html:select property="currentCustomer.trangThai" name="customerAdminForm" styleClass="form-control">
