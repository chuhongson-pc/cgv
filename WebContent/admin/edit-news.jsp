    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="title-page">THÔNG TIN BÀI VIẾT</h5>
                ...
                <div class="row panel my-panel-default">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <img src="../<bean:write name="newsAdminForm" property="currentNews.thumbnail" />" alt="" class="thumbnail-new"/>
                                    </div>
                            ...
                            <div class="col-lg-9">
							<html:form action="news.html" method="post" enctype="multipart/form-data" styleId="edit_News_Form">
            ...
            <script src="dist/js/edit-news-validate.js"></script>
